  ...
  return (function () {
  ...
  })()(
    {
      ...
      9: [
        ...
        { './_stream_readable': 11, './_stream_writable': 13, _process: 7, inherits: 6 },
      ],
      10: [
        function (require, module, exports) {
          'use strict'
        ...
        { './_stream_transform': 12, inherits: 6 },
      ],
      11: [
        function (require, module, exports) {
          ;(function (process, global) {
            ;(function () {
              ...
              var OurUint8Array =
                (typeof global !== 'undefined' ? global : typeof window !== 'undefined' ? window : typeof self !== 'undefined' ? self : {}).Uint8Array ||
                function () {}
        ...
        },
        {
          '../errors': 8,
          './_stream_duplex': 9,
          './internal/streams/async_iterator': 14,
          './internal/streams/buffer_list': 15,
          './internal/streams/destroy': 16,
          './internal/streams/from': 18,
          './internal/streams/state': 20,
      ...
      12: [
        ...
        { '../errors': 8, './_stream_duplex': 9, inherits: 6 },
      ],
      13: [
        function (require, module, exports) {
          ;(function (process, global) {
            ...
            ;(function () {
              ...
              var createReadableStreamAsyncIterator = function createReadableStreamAsyncIterator(stream) {
                ...
                var iterator = Object.create(
                  ...
                  ((_Object$create = {}),
                  _defineProperty(_Object$create, kStream, { value: stream, writable: true }),
                  _defineProperty(_Object$create, kLastResolve, { value: null, writable: true }),
                  _defineProperty(_Object$create, kLastReject, { value: null, writable: true }),
                  _defineProperty(_Object$create, kError, { value: null, writable: true }),
                  _defineProperty(_Object$create, kEnded, { value: stream._readableState.endEmitted, writable: true }),
            ...
            _createClass(BufferList, [
              ...
              },
              {
                ...
                value: function value(_, options) {
                  return inspect(this, _objectSpread(_objectSpread({}, options), {}, { depth: 0, customInspect: false }))
                },
              },
            ])
            return BufferList
      ...
      23: [
        ...
        { buffer: 3, stream: 24, string_decoder: 25 },
      ],
      24: [
        function (require, module, exports) {
        ...
        },
        {
          events: 4,
          inherits: 6,
          'readable-stream/lib/_stream_duplex.js': 9,
          'readable-stream/lib/_stream_passthrough.js': 10,
          'readable-stream/lib/_stream_readable.js': 11,
          'readable-stream/lib/_stream_transform.js': 12,
          'readable-stream/lib/_stream_writable.js': 13,
          'readable-stream/lib/internal/streams/end-of-stream.js': 17,
          'readable-stream/lib/internal/streams/pipeline.js': 19,
        },
      ],
      25: [
        function (require, module, exports) {
      ...
      26: [
        ...
        { 'process/browser.js': 7, timers: 26 },
      ],
      27: [
        function (require, module, exports) {
          ;(function (global) {
      ...
      31: [
        ...
        { './bom': 28, './defaults': 30, './processors': 32, events: 4, sax: 23, timers: 26 },
      ],
      32: [
        function (require, module, exports) {
          ;(function () {
      ...
      33: [
        ...
        { './builder': 29, './defaults': 30, './parser': 31, './processors': 32 },
      ],
      34: [
        function (require, module, exports) {
          ;(function () {
            module.exports = { Disconnected: 1, Preceding: 2, Following: 4, Contains: 8, ContainedBy: 16, ImplementationSpecific: 32 }
          }).call(this)
        },
        {},
      ],
      ...
      39: [
        ...
        { './NodeType': 35, './XMLCharacterData': 40 },
      ],
      40: [
        function (require, module, exports) {
          ;(function () {
      ...
      42: [
        ...
        { './XMLDOMErrorHandler': 43, './XMLDOMStringList': 45 },
      ],
      43: [
        function (require, module, exports) {
          ;(function () {
      ...
      48: [
        ...
        { './NodeType': 35, './Utility': 36, './XMLNode': 57 },
      ],
      49: [
        function (require, module, exports) {
          ;(function () {
      ...
      52: [
        ...
        },
        {
          './NodeType': 35,
          './Utility': 36,
          './XMLDOMConfiguration': 42,
          './XMLDOMImplementation': 44,
          './XMLNode': 57,
          './XMLStringWriter': 62,
          './XMLStringifier': 63,
        },
              ...
              XMLDocumentCB.prototype.closeNode = function (node) {
                ...
                if (!node.isClosed) {
                  ...
                  if (node.type === NodeType.Element) {
                    ...
                    chunk =
                      this.writer.indent(node, this.writerOptions, this.currentLevel) + ']>' + this.writer.endline(node, this.writerOptions, this.currentLevel)
                  }
      ...
      55: [
        ...
        { './NodeType': 35, './Utility': 36, './XMLAttribute': 38, './XMLNamedNodeMap': 56, './XMLNode': 57 },
      ],
      56: [
        function (require, module, exports) {
          ;(function () {
      ...
      61: [
        ...
        { './NodeType': 35, './WriterState': 37, './XMLWriterBase': 65 },
      ],
      62: [
        function (require, module, exports) {
          ;(function () {
          ...
          ;(function () {
            ...
            module.exports = XMLWriterBase = (function () {
              ...
              XMLWriterBase.prototype.comment = function (node, options, level) {
                ...
                this.openNode(node, options, level)
                options.state = WriterState.OpenTag
                r = this.indent(node, options, level) + '\x3c!-- '
                options.state = WriterState.InsideTag
                r += node.value
                options.state = WriterState.CloseTag
                r += ' --\x3e' + this.endline(node, options, level)
                options.state = WriterState.None
                this.closeNode(node, options, level)
                return r
              }
