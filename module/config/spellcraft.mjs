...
/**
 * The Arcane Runes which exist in the Swerpg spellcraft system.
 * These config objects are instantiated as SwerpgRune instances during system initialization.
 * @enum {SwerpgRune}
 */
...
/**
 * The Somatic Gestures which exist in the Swerpg spellcraft system.
 * These config objects are instantiated as SwerpgGesture instances during system initialization.
 * @enum {SwerpgGesture}
 */
export const GESTURES = Object.seal({
  ...
  touch: {
    ...
    description:
      '<p>Touch is one of the most universal somatic gestures. This gesture is easily performed and is typically the first gesture learned by novice spellcasters.</p><p>Touch-based spells cause a small amount of damage or healing, but can be performed quickly requiring less Action than more complex gestures.</p>',
    cost: {
      action: 2,
      focus: 1,
    },
...
/**
 * The Metamagic Inflections which exist in the Swerpg spellcraft system.
 * These config objects are instantiated as SwerpgInflection instances during system initialization.
 * @enum {SwerpgInflection}
 */
...
export const CREATION_SUMMONS = {
  death: 'Compendium.swerpg.summons.Actor.56puGK932Qc0cowe',
  earth: 'Compendium.swerpg.summons.Actor.xTFgTg5Rh2s0s5gZ',
  flame: 'Compendium.swerpg.summons.Actor.RuNh1bFGiHKdHeKI',
  frost: 'Compendium.swerpg.summons.Actor.me5glbOshiijlVUH',
  lightning: 'Compendium.swerpg.summons.Actor.Ne25xsSqYijgcrm0',
  fallback: 'Compendium.swerpg.summons.Actor.RuNh1bFGiHKdHeKI', // FIXME temporary
}
