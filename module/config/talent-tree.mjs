...
export default class SwerpgTalentNode {
  ...
  constructor({ id, tier = 0, type = 'choice', characteristics = [], angle, distance = 200, connected = [], groups = null, point } = {}) {
  ...
  static defineTree() {
    ...
    new SwerpgTalentNode({
      ...
      point: { x: 692, y: 400 },
      teleport: true,
      connected: ['dex2a', 'dex2b', 'dex2c', 'dex3a'],
      groups: {
    ...
    // Toughness Quadrant
    new SwerpgTalentNode({
      id: 'sig3.dexterity.toughness',
      characteristics: ['dexterity', 'toughness'],
      type: 'signature',
      tier: 3,
      connected: ['dex2c', 'dextou2', 'tou2a', 'dex3b'],
    })
    new SwerpgTalentNode({
      id: 'tou3a',
      type: 'attack',
    ...
    new SwerpgTalentNode({
      ...
      point: { x: 0, y: 800 },
      teleport: true,
      connected: ['tou2a', 'tou2b', 'tou2c', 'tou3a'],
      groups: {
    ...
    // Strength Quadrant
    new SwerpgTalentNode({
      id: 'sig3.toughness.strength',
      characteristics: ['toughness', 'strength'],
      type: 'signature',
      tier: 3,
      connected: ['tou2c', 'toustr2', 'str2a', 'tou3b'],
    })
    new SwerpgTalentNode({
      id: 'str3a',
      type: 'attack',
    ...
    new SwerpgTalentNode({
      ...
      tier: 3,
      point: { x: -692, y: 400 },
      connected: ['str2a', 'str2b', 'str2c', 'str3a'],
      groups: {
    ...
    new SwerpgTalentNode({
      ...
      tier: 3,
      point: { x: -692, y: -400 },
      connected: ['wis2a', 'wis2b', 'wis2c', 'wis3a'],
      groups: {
    ...
    new SwerpgTalentNode({
      ...
      tier: 3,
      point: { x: 0, y: -800 },
      connected: ['pre2a', 'pre2b', 'pre2c', 'pre3a'],
      groups: {},
    })
    new SwerpgTalentNode({
      id: 'pre3b',
    ...
    // Intellect Quadrant
    new SwerpgTalentNode({
      id: 'sig3.presence.intellect',
      characteristics: ['presence', 'intellect'],
      type: 'signature',
      tier: 3,
      connected: ['pre2c', 'preint2', 'int2a', 'pre3b'],
    })
    new SwerpgTalentNode({
      id: 'int3a',
      type: 'magic',
    ...
    new SwerpgTalentNode({
      ...
      tier: 3,
      point: { x: 692, y: -400 },
      connected: ['int2a', 'int2b', 'int2c', 'int3a'],
      groups: {},
    })
