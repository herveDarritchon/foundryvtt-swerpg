...
export default class SwerpgTalentNode {
  ...
  static defineTree() {
    ...
    // Dexterity Quadrant
    const sig3intdex = new SwerpgTalentNode({id: "sig3.intellect.dexterity", abilities: ["intellect", "dexterity"],
      type: "signature", tier: 3, connected: ["int2c", "intdex2", "dex2a"]});
    new SwerpgTalentNode({id: "dex3a", type: "attack", abilities: ["dexterity"], tier: 3,
      connected: ["intdex2", "dex2a", "dex2b", "sig3.intellect.dexterity"]});
    new SwerpgTalentNode({id: "sig3.dexterity", type: "signature", abilities: ["dexterity"], tier: 3,
    ...
    new SwerpgTalentNode({id: "dex3b", type: "attack", abilities: ["dexterity"], tier: 3,
      connected: ["dex2b", "dex2c", "dextou2", "sig3.dexterity"]})

    // Toughness Quadrant
    new SwerpgTalentNode({id: "sig3.dexterity.toughness", abilities: ["dexterity", "toughness"], type: "signature",
      tier: 3, connected: ["dex2c", "dextou2", "tou2a", "dex3b"]});
    new SwerpgTalentNode({id: "tou3a", type: "attack", abilities: ["toughness"], tier: 3,
      connected: ["dextou2", "tou2a", "tou2b", "sig3.dexterity.toughness"]});
    new SwerpgTalentNode({id: "sig3.toughness", type: "signature", abilities: ["toughness"], tier: 3, point: {x: 0, y: 800},
    ...
    new SwerpgTalentNode({id: "tou3b", type: "defense", abilities: ["toughness"], tier: 3,
      connected: ["tou2b", "tou2c", "toustr2", "sig3.toughness"]})

    // Strength Quadrant
    new SwerpgTalentNode({id: "sig3.toughness.strength", abilities: ["toughness", "strength"], type: "signature",
      tier: 3, connected: ["tou2c", "toustr2", "str2a", "tou3b"]});
    new SwerpgTalentNode({id: "str3a", type: "attack", abilities: ["strength"], tier: 3,
      connected: ["toustr2", "str2a", "str2b", "sig3.toughness.strength"]});
    new SwerpgTalentNode({id: "sig3.strength", type: "signature", abilities: ["strength"], tier: 3,
    ...
    new SwerpgTalentNode({id: "str3b", type: "attack", abilities: ["strength"], tier: 3,
      connected: ["str2b", "str2c", "strwis2", "sig3.strength"]})

    // Wisdom Quadrant
    new SwerpgTalentNode({id: "sig3.strength.wisdom", abilities: ["strength", "wisdom"], type: "signature", tier: 3,
      connected: ["str2c", "strwis2", "wis2a", "str3b"]});
    new SwerpgTalentNode({id: "wis3a", type: "attack", abilities: ["wisdom"], tier: 3,
      connected: ["strwis2", "wis2a", "wis2b", "sig3.strength.wisdom"]});
    new SwerpgTalentNode({id: "sig3.wisdom", type: "signature", abilities: ["wisdom"], tier: 3, point: {x: -692, y: -400},
      connected: ["wis2a", "wis2b", "wis2c", "wis3a"], groups: {
        "sig3.wisdom.intellect": {abilities: ["wisdom", "intellect"], teleport: "sig3.intellect"},
      }});
    new SwerpgTalentNode({id: "wis3b", type: "magic", abilities: ["wisdom"], tier: 3,
      connected: ["wis2b", "wis2c", "wispre2", "sig3.wisdom"]})

    // Presence Quadrant
    new SwerpgTalentNode({id: "sig3.wisdom.presence", abilities: ["wisdom", "presence"], type: "signature", tier: 3,
      connected: ["wis2c", "wispre2", "pre2a", "wis3b"]});
    new SwerpgTalentNode({id: "pre3a", type: "attack", abilities: ["presence"], tier: 3,
      connected: ["wispre2", "pre2a", "pre2b", "sig3.wisdom.presence"]});
    new SwerpgTalentNode({id: "sig3.presence", type: "signature", abilities: ["presence"], tier: 3, point: {x: 0, y: -800},
      connected: ["pre2a", "pre2b", "pre2c", "pre3a"], groups: {}});
    new SwerpgTalentNode({id: "pre3b", type: "magic", abilities: ["presence"], tier: 3,
      connected: ["pre2b", "pre2c", "preint2", "sig3.presence"]})

    // Intellect Quadrant
    new SwerpgTalentNode({id: "sig3.presence.intellect", abilities: ["presence", "intellect"], type: "signature",
      tier: 3, connected: ["pre2c", "preint2", "int2a", "pre3b"]});
    new SwerpgTalentNode({id: "int3a", type: "magic", abilities: ["intellect"], tier: 3,
      connected: ["preint2", "int2a", "int2b", "sig3.presence.intellect"]});
    new SwerpgTalentNode({id: "sig3.intellect", type: "signature", abilities: ["intellect"], tier: 3,
      point: {x: 692, y: -400}, connected: ["int2a", "int2b", "int2c", "int3a"], groups: {}});
    const int3b = new SwerpgTalentNode({id: "int3b", type: "attack", abilities: ["intellect"], tier: 3,
