...
export default class SwerpgAction extends foundry.abstract.DataModel {
        ...
        return {
            ...
            target: new fields.SchemaField({
                ...
                scope: new fields.NumberField({
                    required: true, initial: SYSTEM.ACTION.TARGET_SCOPES.ALL,
    ...
    * _tests() {
    ...
    async toMessage(targets, {confirmed = false, temporary = false, ...options} = {}) {
        ...
        const content = awaitfoundry.applications.handlebars.renderTemplate("systems/swerpg/templates/dice/action-use-chat.hbs", {
            action: this,
