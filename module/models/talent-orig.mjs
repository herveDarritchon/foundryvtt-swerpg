...
/**
 * The data schema of a Talent type Item in the Swerpg system.
 * @mixes {TalentData}
...
export default class SwerpgTalent extends foundry.abstract.TypeDataModel {
  ...
  static defineSchema() {
    ...
    return {
      ...
      inflection: new fields.StringField({
        required: false,
        choices: SYSTEM.SPELL.INFLECTIONS,
        initial: undefined,
      }),
  ...
  getTags() {
    ...
    if (this.iconicSpells) {
      tags.iconicSpells = this.iconicSpells === 1 ? game.i18n.localize('SPELL.Iconic') : `${this.iconicSpells} ${game.i18n.localize('SPELL.IconicPl')}`
    }
    return tags
  }
