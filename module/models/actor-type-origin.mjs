...
export default class SwerpgActorType extends foundry.abstract.TypeDataModel {
  ...
  static defineSchema() {
    ...
    schema.abilities = new fields.SchemaField(
      Object.values(SYSTEM.CHARACTERISTICS).reduce((obj, ability) => {
        obj[ability.id] = new fields.SchemaField(
          {
            base: new fields.NumberField({ ...requiredInteger, initial: 0, min: 0, max: 3 }),
            trained: new fields.NumberField({ ...requiredInteger, initial: 0, min: 0, max: 12 }),
    ...
    schema.defenses = new fields.SchemaField(
      Object.values(SYSTEM.DEFENSES).reduce((obj, defense) => {
        if (defense.id !== 'physical')
    ...
    schema.resistances = new fields.SchemaField(
      Object.values(SYSTEM.DAMAGE_TYPES).reduce((obj, damageType) => {
