/**
 * The data structure and functionality of an Arcane Rune in the Swerpg spellcraft system.
 */
export default class SwerpgRune extends foundry.abstract.DataModel {
  static defineSchema() {
    ...
    return {
      ...
      defense: new fields.StringField({
        choices: Object.values(SYSTEM.DEFENSES).reduce((obj, d) => {
   ...
   */
  get tags() {
    const tags = [SYSTEM.CHARACTERISTICS[this.scaling].label, SYSTEM.RESOURCES[this.resource].label, SYSTEM.DEFENSES[this.defense].label]
