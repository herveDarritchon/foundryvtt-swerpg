 ...
 */
export default class SwerpgBackground extends foundry.abstract.TypeDataModel {
  ...
  static defineSchema() {
    ...
    return {
      ...
      skills: new fields.SetField(new fields.StringField({required: true, choices: SYSTEM.SKILLS}), {
        validate: SwerpgBackground.#validateSkills
      }),
      talents: new fields.SetField(new fields.DocumentUUIDField({type: "Item"}), {
        validate: SwerpgBackground.#validateTalents
      })
    };
  }
