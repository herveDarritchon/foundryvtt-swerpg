/**
 * The data structure and functionality of a Metamagic Inflection in the Swerpg spellcraft system.
 */
export default class SwerpgInflection extends foundry.abstract.DataModel {
    ...
    static initialize() {
        ...
        for (const [k, v] of Object.entries(inflections)) {
            inflections[k] = new SwerpgInflection(v);
        }
