...
/**
 * A SwerpgBaseItemSheet subclass used to configure Items of the "background" type.
 */
export default class BackgroundSheet extends SwerpgBaseItemSheet {
   ...
   * @type {string}
   */
  static talentPartial = "systems/swerpg/templates/sheets/partials/included-talent.hbs";
   ...
   * @param {SwerpgItem} talent     The talent item being displayed
