...
/**
 * A configuration application used to advance skill ranks and choose skill specialization for a SwerpgActor.
...
export default class SkillConfig extends api.HandlebarsApplicationMixin(api.DocumentSheetV2) {
    ...
    static DEFAULT_OPTIONS = {
        classes: ["swerpg", "skill", "standard-form"],
        tag: "form",
    ...
    static PARTS = {
        skill: {
            root: true,
            template: "systems/swerpg/templates/sheets/actor/skill.hbs",
