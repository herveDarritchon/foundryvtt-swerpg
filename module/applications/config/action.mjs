...
import SwerpgItem from '../../documents/item.mjs'
...
export default class ActionConfig extends api.HandlebarsApplicationMixin(api.DocumentSheetV2) {
  constructor({ action, ...options } = {}) {
    ...
    if (!(document instanceof SwerpgItem)) {
  ...
  static DEFAULT_OPTIONS = {
    classes: ['swerpg', 'action', 'standard-form'],
    tag: 'form',
   ...
   * @type {string}
   */
  static ACTIVE_EFFECT_PARTIAL = 'systems/swerpg/templates/sheets/action/effect.hbs'

  /**
   * A template partial used for rendering a Hook inside an Action.
   * @type {string}
   */
  static HOOK_PARTIAL = 'systems/swerpg/templates/sheets/action/hook.hbs'

  /** @override */
  static PARTS = {
    header: {
      id: 'header',
      template: 'systems/swerpg/templates/sheets/action/header.hbs',
    },
    tabs: {
      id: 'tabs',
    ...
    description: {
      id: 'description',
      template: 'systems/swerpg/templates/sheets/action/description.hbs',
    },
    usage: {
      id: 'usage',
      template: 'systems/swerpg/templates/sheets/action/usage.hbs',
    },
    target: {
      id: 'target',
      template: 'systems/swerpg/templates/sheets/action/target.hbs',
    },
    effects: {
      id: 'effects',
      template: 'systems/swerpg/templates/sheets/action/effects.hbs',
      templates: [ActionConfig.ACTIVE_EFFECT_PARTIAL],
    },
    hooks: {
      id: 'hooks',
      template: 'systems/swerpg/templates/sheets/action/hooks.hbs',
  ...
  static async #onAddEffect(event) {
    const html = await foundry.applications.handlebars.renderTemplate(this.constructor.ACTIVE_EFFECT_PARTIAL, {
