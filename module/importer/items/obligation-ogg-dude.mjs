...
import { getObligationImportStats, incrementObligationImportStat, resetObligationImportStats } from '../utils/obligation-import-utils.mjs'
  ...
  for (const xmlObligation of obligations) {
    ...
    try {
      ...
      if (xmlObligation.Source) {
        ...
        const sources = Array.isArray(xmlObligation.Sources.Source) ? xmlObligation.Sources.Source : [xmlObligation.Sources.Source]
