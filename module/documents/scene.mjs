/**
 * A Scene subclass which extends the base Scene document with some Swerpg-specific functionalities.
 */
export default class SwerpgScene extends Scene {
    ...
    getDimensions() {
        ...
        const sourceGrid = new grid.constructor({
            ...grid,
            size: this._source.grid.size,
            distance: this._source.grid.distance
        });
