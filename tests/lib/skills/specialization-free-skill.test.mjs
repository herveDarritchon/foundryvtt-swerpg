...
describe('SpecializationFreeSkill', () => {
  describe('getCost', () => {
  ...
  describe('process', () => {
    test('should prepare specialization free rank increase and spent free rank update when training', async () => {
      const actor = createActor()
    ...
    test('should prepare specialization free rank decrease and spent free rank update when forgetting', async () => {
      const actor = createActor({
    ...
    describe('validation errors', () => {
      test('should return ErrorSkill when training would put more than 1 specialization free rank into the same skill', async () => {
        const actor = createActor()
      ...
      test('should return ErrorSkill when forgetting a skill with no specialization free rank', async () => {
        const actor = createActor()
  ...
  describe('updateState', () => {
    ...
    test('should not persist when the skill has not been evaluated', async () => {
      ...
      const specializationFreeSkill = new SpecializationFreeSkill(actor, data, {}, {})
