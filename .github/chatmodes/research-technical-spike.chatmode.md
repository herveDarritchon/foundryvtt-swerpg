...
- Parse spike document completely using search tools
...
- Mark "Parse spike document" todo as in-progress
- Use search tools to extract all research questions and success criteria
...
- Use problems tool to analyze any issues discovered
