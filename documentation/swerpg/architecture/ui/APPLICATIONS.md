...
Ce document décrit comment sont conçues, structurées et étendues les applications UI du système **Star Wars Edge RPG (swerpg)** : feuilles d’acteur, feuilles d’item, dialogues et autres écrans métiers. Il s’adresse à la fois :
...
### Feuilles dérivées de `SwerpgBaseActorSheet`
...
### Spécialisations de `SwerpgBaseItemSheet`
...
### Règles de nommage des classes de feuilles
...
### 12.2 Structure HTML recommandée
