...
export class SwerpgAdversaryData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    ...
    return {
      ...
      // Capacités spéciales
      abilities: new fields.ArrayField(new fields.StringField({ required: true })),
    }
  }
  ...
  static defineSchema() {
    ...
    return {
      ...
      prerequisites: new fields.SchemaField({
        ...
        skills: new fields.ObjectField({ required: false }),
        talents: new fields.ArrayField(new fields.StringField({ required: true })),
      ...
      // Actions associées
      actions: new fields.ArrayField(new fields.ObjectField({ required: true })),
    }
  }
...
export class SwerpgActionData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    ...
    return {
      ...
      // Effets de l'action
      effects: new fields.ArrayField(new fields.ObjectField({ required: true })),
